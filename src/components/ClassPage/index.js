...
const ClassPage = (props) => {
    ...
    const getDatafromServer = async () =>{
        var res = await axios.post('http://192.249.18.245:8081/class/info',  {classId: classId}, {
            headers: {
    ...
    return(<div>
        ...
        <Modal isOpen={modalState} onRequestClose={closeModal}>
                <form onSubmit = {function(e){
                    ...
                    console.log(req);
                    //debugger;
                    axios.post('http://192.249.18.245:8081/class/assignment/create?classId='+classId, req,
                    {
                        headers: {
                            'x-access-token': token
                        }
